    ...
    <div class="phonetic-table">
        <div class="vowels-block">
            <div class="single-vowels">
               ...
               <div class="tbl">
                   <div class="tbl-row">
                       <div class="tbl-cell show-youtube" v-bind:href="`https://www.youtube.com/watch?v=PIu5WDIco0I&autoplay=1`">
                           <span class="sound">iː</span>
                           <span class="word-example">gr<span class="accent-tip">ee</span>n</span>
                       </div>
                       <div class="tbl-cell show-youtube" v-bind:href="`https://www.youtube.com/watch?v=Ok_HG-0lNCA&autoplay=1`">
            ...
            <div class="diphtongs">
                ...
                <div class="tbl">
                    ...
                    <div class="tbl-row">
                        ...
                        <div class="tbl-cell show-youtube" v-bind:href="`https://www.youtube.com/watch?v=8uD-GuuSgyk=1&autoplay=1`">
