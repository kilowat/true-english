    ...
    export default {
        ...
        watch: {
            ...
            selectedRow(value){
                ...
                if(this.dataBase.table_dict_history != undefined){
                    this.dataBase.table_dict_history.update({
                        id: this.id,
        ...
        created() {
            ...
            /*
            window.db.delete('true_english_dict').then(function (ev) {
        ...
        methods: {
            fetchData() {
                let dataFetchUrl = `${this.url}?page=${this.currentPage}&column=${this.sortedColumn}&order=${this.order}&per_page=${this.perPage}&like=${this.like}`;                this.working = true;
                axios.get(dataFetchUrl)
                    .then(({ data }) => {
                        this.pagination = data
                        this.tableData = data.data
                        this.working = false;
                        if(this.dataBase.table_dict_history) {
                            this.dataBase.table_dict_history.update({
                                id: this.id,
                                page: this.currentPage,
