...
@section('title', 'Создать видео для парсинга')

@section('content_header')
    <h1>Создать видео для парсинга</h1>
@stop
    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form" method="post" action="{{ route("admin.youtube-video.store") }}" enctype="multipart/form-data">
                    @csrf
                    <!-- text input -->
