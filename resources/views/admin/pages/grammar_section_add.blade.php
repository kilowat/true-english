...
@section('title', 'Создать раздел грамматики')

@section('content_header')
    <h1>Создать раздел грамматики</h1>
@stop
    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form" method="post" action="{{ route("admin.grammar-section.store") }}" enctype="multipart/form-data">
                    @csrf
                    <!-- text input -->
